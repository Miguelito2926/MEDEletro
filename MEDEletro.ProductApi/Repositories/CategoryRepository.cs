...
namespace MEDEletro.ProductApi.Repositories
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        {
            // Implemnetação não indicada para uso em produção pois dependendo do tamanho pode trazer muitos dados e travar a consulta
        ...
        public async Task<Category> Cerate(Category category)
        {
